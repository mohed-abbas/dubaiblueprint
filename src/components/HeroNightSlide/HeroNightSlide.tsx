...
import styles from "./HeroNightSlide.module.css";
...
export interface HeroNightSlideProps {
  headline?: {
    primary: string;
    gradient: string;
  };
...
const defaultProps: Required<HeroNightSlideProps> = {
  headline: {
    primary: "See Clearly.",
...
export function HeroNightSlide({
